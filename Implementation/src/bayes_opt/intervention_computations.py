...
def numerical_optimization_with_prior(acquisition, inputs: ndarray, task: str, exploration_set, priors_regret, temporal_index, iteration,) -> ndarray:
    ...
    # print(np.shape(improvements))
    # print(temporal_index, iteration)

    improvements_with_prior = np.multiply(improvements,abs(priors_regret[iteration][temporal_index]))

    # print('--------------')
    # print('--------------')
    # print(improvements_with_prior)
    # print('--------------')
    # print('--------------')
    ...
    if task == "min":
        idx = argmax(improvements_with_prior)
    else:
        idx = argmin(improvements_with_prior)
...
def evaluate_acquisition_function_with_prior(
    parameter_intervention_domain: ndarray,
    bo_model,
    mean_function,
    variance_function,
    ...
    # print(temporal_index, ':', iteration, ' in evaluate_acquisition_function_with_prior e mi arrivano i prior con regret')
    # print(priors_regret[iteration][temporal_index])
    ...
    x_new = numerical_optimization_with_prior(acquisition, sampled_points, task, exploration_set, priors_regret, temporal_index, iteration)
    ...
    #     print(temporal_index, iteration)
    #     print('x_new: ', x_new)
    #     print('y_acquisition: ', y_acquisition)
    return y_acquisition, x_new