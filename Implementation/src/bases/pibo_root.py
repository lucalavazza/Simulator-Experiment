...
class Root:
    ...
    def _per_trial_computations(self, t: int, it: int, target: str, assigned_blanket: dict, priors_regret:list ,method: str = None) -> None:
        ...
        self._evaluate_acquisition_functions(t, current_best_global_target, it, priors_regret)
